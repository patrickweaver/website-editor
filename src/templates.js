import { getBodyBackgroundColor, getCurrentFaviconURL, getCurrentSocialImage } from "./util/dom"
...
const {url: currentSocialImageURL, alt: currentSocialImageAlt } = getCurrentSocialImage();
...
export const LOCAL_CONTROLS_HTML = `
    ...
    document.documentElement.lang
          ...
          <div class="controls-section">
            ...
            <input type="color" value="${getBodyBackgroundColor()}" class="${COLOR_PICKER_CLASS}" id="${UPDATE_BACKGROUND_COLOR_ID}" />
          </div>
