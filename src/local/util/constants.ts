...
export const ALERT_CLASS = "alert";
...
export const EDIT_UI_SUB_PANEL_CLASS = "editor-sub-container";
export const NON_DESTRUCTIVE_BUTTON_CLASS = "non-destructive";
export const DESTRUCTIVE_BUTTON_CLASS = "destructive";
export const SAVE_BUTTON_CLASS = "save";
...
export const IMAGE_PLACEHOLDER_CLASS = "image-placeholder";
...
export const LOCAL_CONTROLS_BODY_CLASS = "local-controls-enabled";
export const LOCAL_CONTROLS_MINIMIZED_BODY_CLASS =
  "local-controls-enabled-minimized";
